"""
AI Flight Search Agent - Enhanced with Structured Output
"""
...
def create_itinerary():
    ...
    itinerary = agent.create_structured_itinerary(destination, keywords, remaining_budget, duration_days, hotels)
