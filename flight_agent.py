"""
AI Flight Search Agent - Complete with Meal Planning
"""
...
class FlightSearchAgent:
            ...
            if "best_flights" in flight_data:
                for flight in flight_data.get("best_flights", []):
                    ...
                    if outbound_flights and len(outbound_flights) > 0:
                        ...
                        outbound_info = {
                            "departure_time": first_leg.get("departure_airport", {}).get("time", "TBD"),
                            "arrival_time": last_leg.get("arrival_airport", {}).get("time", "TBD"),
                        }
                    
                    return_info = {"departure_time": "TBD", "arrival_time": "TBD"}
    ...
    def sort_flights_by_value(self, flight_results):
        ...
        def flight_score(flight):
            ...
            return (price_score * 0.4) + (out_dep / 24 * 0.3) + (abs(-ret_dep) / 24 * 0.3)
...
- Include breakfast, lunch, and dinner restaurants for EACH day
- Each meal should have: restaurant name, cuisine type, cost, description, and address/area
- Make restaurant recommendations specific to the day's theme and activities
- Vary restaurant types (cafes, local spots, fine dining, street food, etc.)
- Include price range indicators in descriptions
...
Respond with ONLY JSON, no other text before or after."""
        ...
        try:
            ...
            return {
                "overview": {"destination": destination, "description": "Itinerary generated"},
                "daily_itinerary": [],
                "budget_summary": {},
